...
DOCS = {
    # 🔴 정본은 «_v2» 다 (2026-09-08 고침). 생성기는 2026-09-04 부터 v2 파일을 내는데
    #    여기가 옛 파일을 가리키고 있어, Confluence 9번 쪽이 «판 1.7·57쪽» 에 멈춰 있었다.
    #    ⚠ 옛 파일(`…사용자매뉴얼.docx`, 판 1.7)은 지우지 않고 그대로 둔다 — 지난 판이다.
    "manual": {
        "docx": "업무현황_대시보드_사용자매뉴얼_v2.docx",
        "pdf": "업무현황_대시보드_사용자매뉴얼_v2.pdf",
