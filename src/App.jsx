...
//          ΔE 는 큰 면적 기준이라 작은 점에 그대로 쓸 수 없다.
//   4차 ①밝기 45~85 ②이름 유일 ③ΔE 최대 — 세 조건으로 «컴퓨터가» 골랐다 (ΔE 52.9).
// 고르는 도구 = `tools/pick-colors.mjs` — 버리지 말 것. 사람이 늘면 다시 돌린다.
const WORKER_COLORS=[
  '#2563eb','#ea580c','#ec4899','#06b6d4','#4ade80','#d8b4fe',
  '#facc15','#a855f7','#f87171','#14b8a6','#fdba74','#93c5fd',
]
...
const VEHICLE_COLORS=[
  '#ef4444','#0e7490','#84cc16','#d946ef','#ca8a04','#0d9488',
  '#c084fc','#fb923c','#22d3ee','#be185d','#65a30d','#64748b',
]
